  ...
  return (
    <div className="px-6 sm:px-10 pt-6">
      <div className="max-w-[1280px] mx-auto bg-navy rounded-[34px] h-12 flex items-center justify-between px-7 text-xs font-semibold text-white/60 tracking-[0.2px]">
        ...
        <Link
          href="/portal"
          className="text-white flex items-center gap-2 ml-auto no-underline"
        >
          Client login
          <svg width="8" height="12" viewBox="0 0 8 14" fill="none">
            <path
              d="M 0 12 L 5 7 L 0 2 L 1 0 L 8 7 L 1 14 L 0 12 Z"
              fill="currentColor"
            />
          </svg>
        </Link>
      ...
      <div className="max-w-[1280px] mx-auto mt-2.5 bg-white rounded-[34px] h-[58px] shadow-[0_4px_12px_rgba(0,0,0,0.07)] flex items-center justify-between px-8 relative">
        <Link
          href="/"
          className="font-bold text-[22px] text-navy no-underline"
        >
          TSAPtest
        </Link>
